...
test('Assert discounted Mocha added to the Cart after promo accepting', async ({
  ...
  await cartPage.assertCoffeeTotalCostContainsCorrectText('Espresso', espressoPrice);
  await cartPage.assertCoffeeTotalCostContainsCorrectText('Mocha', discMochaPrice);
  await cartPage.assertCoffeeTotalCostContainsCorrectText('Cappuccino', cappuccinoPrice);
  await cartPage.assertCoffeeTotalCostContainsCorrectText('Americano', americanoPrice);
});
